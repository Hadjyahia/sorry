            ...
            call.enqueue(new Callback<User>() {
                ...
                public void onResponse(Call<User> call, Response<User> response) {
                    ...
                    switch (personGroupBlood){
                        case "A_plus" : textViewBloodGroup.setText("A+"); break;
                        case "A_moins" : textViewBloodGroup.setText("A-"); break;

                        case "O_plus" : textViewBloodGroup.setText("O+"); break;
                        case "O_moins" : textViewBloodGroup.setText("O-");; break;

                        case "B_plus" : textViewBloodGroup.setText("B+"); break;
                        case "B_moins" : textViewBloodGroup.setText("B-"); break;

                        case "AB_plus" : textViewBloodGroup.setText("AB+\n"); break;
                        case "AB_moins" : textViewBloodGroup.setText("AB-\n"); break;
