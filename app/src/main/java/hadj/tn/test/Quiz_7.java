...
public class Quiz_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        close = findViewById(R.id.quit7);
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Quiz_7.this,HomeActivity.class);
                startActivity(intent);
            }
        });
        no= findViewById(R.id.btn17);
        ...
        yes = findViewById(R.id.btn07);
        yes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder dialogEditPhone = new AlertDialog.Builder(Quiz_7.this);
